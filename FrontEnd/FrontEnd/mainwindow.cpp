...
void MainWindow::setRoomID(const QString& roomID)
{
	...
	uiMain.label_2->setText(m_roomID);
}
...
void MainWindow::fetchAndDisplayPlayers() {
	QString rc = m_roomID;
	QNetworkRequest request(QUrl(QString("http://localhost:18080/getLobbyInfo?lobbyCode=%1").arg(rc)));
	networkManager->get(request);
}

void MainWindow::onPlayersFetched(QNetworkReply* reply) {
